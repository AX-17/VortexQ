...
internal class EnumerableSerializer<T> : FieldSerializer<IEnumerable<T>>
{
    protected override IEnumerable<T> ReadOverride(BinaryReader br)
    {
    ...
    protected override void WriteOverride(BinaryWriter bw, IEnumerable<T> value)
    {
